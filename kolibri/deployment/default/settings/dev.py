...
CSP_DEFAULT_SRC += ("localhost:3000", "ws:", "wizardly-lovelace.local:3000")  # noqa F405
CSP_SCRIPT_SRC += ("localhost:3000", "wizardly-lovelace.local:3000")  # noqa F405
CSP_STYLE_SRC += ("localhost:3000", "wizardly-lovelace.local:3000")  # noqa F405
